...
<head>
    ...
    <script src="{{asset('assets/js/plugins/datatables.min.js')}}">
    </script>
    ...
    <!-- <link href="{{asset('assets/css/airbnb.css')}}" rel="stylesheet" /> -->
    <link href="{{asset('assets/css/material_orange.css')}}" rel="stylesheet" />
